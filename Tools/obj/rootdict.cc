...
#define R__DICTIONARY_FILENAME objdIrootdict
...
"/uscms_data/d3/bcaraway/analysis/CMSSW_10_2_9/src/ZInvisible/Tools/",
0
    };
...
class __attribute__((annotate("$clingAutoload$TLorentzVector.h")))  __attribute__((annotate("$clingAutoload$rootdict.h")))  TLorentzVector;
