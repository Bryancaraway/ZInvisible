...
int main(int argc, char* argv[])
{
    ...
    // photons
    // only passing pt cut: ratio = photonLVecGenPt / photonLVecGen
    //auto makePDCPhotonPtCut_single  = [&](const std::string& var, const std::string& style) {return Plotter::DataCollection(style, {{"photonLVecGenEtaPt("+var+")", makePDSPhoton("genEtaPt")},             {"photonLVecGenPt("+var+")", makePDSPhoton("genPt")}}); };
    //auto makePDCPhotonPtCut_ratio   = [&](const std::string& var, const std::string& style) {return Plotter::DataCollection(style, {{"photonLVecGenEtaPt("+var+")", makePDSPhoton("genEtaPt over genPt")},  {"photonLVecGenPt("+var+")", makePDSPhoton("genEtaPt over genPt")}}); };
